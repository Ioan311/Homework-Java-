...
public class Main {
    public static void main(String[] args) {
        ...
        //Products.Livrator l1 = new Products.Livrator("Sima", "Marian", 32, "0721434221", 22);
        //Order.BonFiscal b1 = new Order.BonFiscal(56, 67.8f, 3.5f, (List<Products.Preparate>) p1);
